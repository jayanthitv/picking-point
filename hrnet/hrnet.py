...
from hrnet.nets.hrnet import HRnet
from hrnet.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class HRnet_Segmentation(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        "model_path"        : 'hrnet/weight/adam-18-best_epoch_weights.pth',
        #----------------------------------------#
        #   所需要区分的类的个数+1
        #----------------------------------------#
        "num_classes"       : 2,
